...
class AffiliateEntity {
  ...
  make() {
    return new AffiliateEntity(this.#client, this.entopts())
  }
  ...
  toJSON() {
    return { ...(this.#data || {}), _entity: 'Affiliate' }
  }

  toString() {
    return 'Affiliate ' + this.#utility.struct.jsonify(this.#data)
  }
  ...
  async create(this: any, reqdata?: any, ctrl?: Control) {
    ...
    let op: Operation = opify({
      ...
      pathalt: [{"path":"/v2/affiliates/{id}","id":true}],
      params: [
  "id"
],
      alias: {},
