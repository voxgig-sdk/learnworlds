...
class UserProgressEntity {
  ...
  make() {
    return new UserProgressEntity(this.#client, this.entopts())
  }
  ...
  toJSON() {
    return { ...(this.#data || {}), _entity: 'UserProgress' }
  }

  toString() {
    return 'UserProgress ' + this.#utility.struct.jsonify(this.#data)
  }
  ...
  async load(this: any, reqmatch?: any, ctrl?: Control) {
    ...
    const op: Operation = opify({
      ...
      pathalt: [{"path":"/v2/users/{user_id}/courses/{cid}/progress","user_id":true,"cid":true}],
      params: [
  "user_id",
  "cid"
],
      ...
      reqform: "`body`",
      resform: "`body`",
      validate: { "params": { "user_id": "`$STRING`", "cid": "`$STRING`", "Authorization": "`$STRING`", "Lw-Client": "`$STRING`" } },
    })
  ...
  async list(this: any, reqmatch?: any, ctrl?: Control) {
    ...
    let op: Operation = opify({
      ...
      pathalt: [{"path":"/v2/users/{user_id}/progress","user_id":true}],
      params: [
  "user_id"
],
      alias: {},
