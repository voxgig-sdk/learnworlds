...
class ProductEntity {
  ...
  make() {
    return new ProductEntity(this.#client, this.entopts())
  }
  ...
  toJSON() {
    return { ...(this.#data || {}), _entity: 'Product' }
  }

  toString() {
    return 'Product ' + this.#utility.struct.jsonify(this.#data)
  }
  ...
  async list(this: any, reqmatch?: any, ctrl?: Control) {
    ...
    let op: Operation = opify({
      ...
      pathalt: [{"path":"/v2/users/{user_id}/products","user_id":true}],
      params: [
  "user_id"
],
      alias: {},
