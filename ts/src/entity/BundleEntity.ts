...
class BundleEntity {
  ...
  make() {
    return new BundleEntity(this.#client, this.entopts())
  }
  ...
  toJSON() {
    return { ...(this.#data || {}), _entity: 'Bundle' }
  }

  toString() {
    return 'Bundle ' + this.#utility.struct.jsonify(this.#data)
  }
  ...
  async load(this: any, reqmatch?: any, ctrl?: Control) {
    ...
    const op: Operation = opify({
      ...
      name: 'load',
      path: '/v2/bundles/{id}',
      pathalt: [{"path":"/v2/bundles/{id}","id":true}],
      params: [
  "id"
],
      alias: {},
