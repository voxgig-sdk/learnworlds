...
class SeatEntity {
  ...
  make() {
    return new SeatEntity(this.#client, this.entopts())
  }
  ...
  toJSON() {
    return { ...(this.#data || {}), _entity: 'Seat' }
  }

  toString() {
    return 'Seat ' + this.#utility.struct.jsonify(this.#data)
  }
  ...
  async load(this: any, reqmatch?: any, ctrl?: Control) {
    ...
    const op: Operation = opify({
      ...
      pathalt: [{"path":"/v2/seats/{id}","id":true,"user_id":false},{"path":"/v2/users/{user_id}/seats","user_id":true,"id":false}],
      params: [
  "id",
  "user_id"
],
