...
class CourseEntity {
  ...
  make() {
    return new CourseEntity(this.#client, this.entopts())
  }
  ...
  toJSON() {
    return { ...(this.#data || {}), _entity: 'Course' }
  }

  toString() {
    return 'Course ' + this.#utility.struct.jsonify(this.#data)
  }
  ...
  async load(this: any, reqmatch?: any, ctrl?: Control) {
    ...
    const op: Operation = opify({
      ...
      name: 'load',
      path: '/v2/courses/{id}',
      pathalt: [{"path":"/v2/courses/{id}","id":true}],
      params: [
  "id"
],
      alias: {},
