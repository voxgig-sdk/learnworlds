...
exports.UserSubscriptionEntity = void 0;
...
class UserSubscriptionEntity {
    ...
    make() {
        return new UserSubscriptionEntity(this.#client, this.entopts());
    }
    data(data) {
        const featurehook = this.#utility.featurehook;
        if (null != data) {
    ...
    toJSON() {
        return { ...(this.#data || {}), _entity: 'UserSubscription' };
    }
    toString() {
        return 'UserSubscription ' + this.#utility.struct.jsonify(this.#data);
    }
    ...
    async list(reqmatch, ctrl) {
        ...
        let op = opify({
            ...
            pathalt: [{ "path": "/v2/user-subscriptions" }],
            params: [],
            alias: {},
            state: {},
            reqform: "`body`",
