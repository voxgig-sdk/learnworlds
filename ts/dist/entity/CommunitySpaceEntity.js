...
exports.CommunitySpaceEntity = void 0;
...
class CommunitySpaceEntity {
    ...
    make() {
        return new CommunitySpaceEntity(this.#client, this.entopts());
    }
    data(data) {
        const featurehook = this.#utility.featurehook;
        if (null != data) {
    ...
    toJSON() {
        return { ...(this.#data || {}), _entity: 'CommunitySpace' };
    }
    toString() {
        return 'CommunitySpace ' + this.#utility.struct.jsonify(this.#data);
    }
    ...
    async load(reqmatch, ctrl) {
        ...
        const op = opify({
            ...
            pathalt: [{ "path": "/v2/community/spaces/{id}", "id": true }],
            params: [
                "id"
            ],
            alias: {},
            ...
            reqform: "`body`",
            resform: "`body`",
            validate: { "params": { "id": "`$STRING`", "Lw-Client": "`$STRING`", "Authorization": "`$STRING`" } },
        });
        let ctx = contextify({
            current: new WeakMap(),
            ctrl,
    ...
    async list(reqmatch, ctrl) {
        ...
        let op = opify({
            ...
            pathalt: [{ "path": "/v2/community/spaces" }],
            params: [],
            alias: {},
            state: {},
            reqform: "`body`",
...
exports.CommunitySpaceEntity = CommunitySpaceEntity;
//# sourceMappingURL=CommunitySpaceEntity.js.map