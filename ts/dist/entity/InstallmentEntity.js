...
exports.InstallmentEntity = void 0;
...
class InstallmentEntity {
    ...
    make() {
        return new InstallmentEntity(this.#client, this.entopts());
    }
    data(data) {
        const featurehook = this.#utility.featurehook;
        if (null != data) {
    ...
    toJSON() {
        return { ...(this.#data || {}), _entity: 'Installment' };
    }
    toString() {
        return 'Installment ' + this.#utility.struct.jsonify(this.#data);
    }
    ...
    async list(reqmatch, ctrl) {
        ...
        let op = opify({
            ...
            pathalt: [{ "path": "/v2/installments/active" }],
            params: [],
            alias: {},
            state: {},
            reqform: "`body`",
...
exports.InstallmentEntity = InstallmentEntity;
