...
exports.CourseAnalyticEntity = void 0;
const node_util_1 = require("node:util");
class CourseAnalyticEntity {
    #client;
    #entopts;
    #utility;
    #data;
    ...
    make() {
        return new CourseAnalyticEntity(this.#client, this.entopts());
    }
    data(data) {
        const featurehook = this.#utility.featurehook;
        if (null != data) {
    ...
    toJSON() {
        return { ...(this.#data || {}), _entity: 'CourseAnalytic' };
    }
    toString() {
        return 'CourseAnalytic ' + this.#utility.struct.jsonify(this.#data);
    }
    ...
    async load(reqmatch, ctrl) {
        ...
        const op = opify({
            ...
            pathalt: [{ "path": "/v2/courses/{course_id}/analytics", "course_id": true }],
            params: [
                "course_id"
            ],
            alias: {},
...
exports.CourseAnalyticEntity = CourseAnalyticEntity;
