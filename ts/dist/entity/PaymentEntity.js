...
class PaymentEntity {
    ...
    make() {
        return new PaymentEntity(this.#client, this.entopts());
    }
    data(data) {
        const featurehook = this.#utility.featurehook;
        if (null != data) {
    ...
    toJSON() {
        return { ...(this.#data || {}), _entity: 'Payment' };
    }
    toString() {
        return 'Payment ' + this.#utility.struct.jsonify(this.#data);
    }
    ...
    async load(reqmatch, ctrl) {
        ...
        const op = opify({
            ...
            name: 'load',
            path: '/v2/payments/{id}',
            pathalt: [{ "path": "/v2/payments/{id}", "id": true }],
            params: [
                "id"
            ],
            alias: {},
    ...
    async list(reqmatch, ctrl) {
        ...
        let op = opify({
            ...
            name: 'list',
            path: '/v2/payments',
            pathalt: [{ "path": "/v2/affiliates/{affiliate_id}/payments", "affiliate_id": true }, { "path": "/v2/payments", "affiliate_id": false }],
            params: [
                "affiliate_id"
            ],
            alias: {},
