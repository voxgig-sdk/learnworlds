...
exports.PayoutDueUpcomingEntity = void 0;
const node_util_1 = require("node:util");
class PayoutDueUpcomingEntity {
    #client;
    #entopts;
    #utility;
    #data;
    ...
    make() {
        return new PayoutDueUpcomingEntity(this.#client, this.entopts());
    }
    data(data) {
        const featurehook = this.#utility.featurehook;
        if (null != data) {
    ...
    toJSON() {
        return { ...(this.#data || {}), _entity: 'PayoutDueUpcoming' };
    }
    toString() {
        return 'PayoutDueUpcoming ' + this.#utility.struct.jsonify(this.#data);
    }
    ...
    async list(reqmatch, ctrl) {
        ...
        let fres = undefined;
        let op = opify({
            entity: 'payout_due_upcoming',
            name: 'list',
            path: '/v2/affiliates/{affiliate_id}/payouts/upcoming',
            pathalt: [{ "path": "/v2/affiliates/{affiliate_id}/payouts/upcoming", "affiliate_id": true }],
            params: [
                "affiliate_id"
            ],
            alias: {},
...
exports.PayoutDueUpcomingEntity = PayoutDueUpcomingEntity;
