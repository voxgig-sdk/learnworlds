...
class UserResponseEntity {
    ...
    make() {
        return new UserResponseEntity(this.#client, this.entopts());
    }
    data(data) {
        const featurehook = this.#utility.featurehook;
        if (null != data) {
    ...
    toJSON() {
        return { ...(this.#data || {}), _entity: 'UserResponse' };
    }
    toString() {
        return 'UserResponse ' + this.#utility.struct.jsonify(this.#data);
    }
    ...
    async list(reqmatch, ctrl) {
        ...
        let op = opify({
            ...
            pathalt: [{ "path": "/v2/assessments/{assessment_id}/responses", "assessment_id": true, "form_id": false }, { "path": "/v2/forms/{form_id}/responses", "form_id": true, "assessment_id": false }],
            params: [
                "assessment_id",
                "form_id"
            ],
            ...
            reqform: "`body`",
            resform: "`body.data`",
            validate: { "params": { "form_id": "`$STRING`", "Authorization": "`$STRING`", "Lw-Client": "`$STRING`" } },
        });
        let ctx = contextify({
            current: new WeakMap(),
            ctrl,
    ...
    async create(reqdata, ctrl) {
        ...
        let op = opify({
            ...
            pathalt: [{ "path": "/v2/assessments/scores/{score_id}/review", "score_id": true }],
            params: [
                "score_id"
            ],
            alias: {},
            ...
            reqform: "`reqdata`",
            resform: "`body`",
            validate: { "params": { "score_id": "`$STRING`", "Authorization": "`$STRING`", "Lw-Client": "`$STRING`" } },
        });
        let ctx = contextify({
            current: new WeakMap(),
            ctrl,
...
//# sourceMappingURL=UserResponseEntity.js.map