...
exports.PayoutCompletedEntity = void 0;
const node_util_1 = require("node:util");
class PayoutCompletedEntity {
    #client;
    #entopts;
    #utility;
    #data;
    ...
    make() {
        return new PayoutCompletedEntity(this.#client, this.entopts());
    }
    data(data) {
        const featurehook = this.#utility.featurehook;
        if (null != data) {
    ...
    toJSON() {
        return { ...(this.#data || {}), _entity: 'PayoutCompleted' };
    }
    toString() {
        return 'PayoutCompleted ' + this.#utility.struct.jsonify(this.#data);
    }
    ...
    async list(reqmatch, ctrl) {
        ...
        let fres = undefined;
        let op = opify({
            entity: 'payout_completed',
            name: 'list',
            path: '/v2/affiliates/{affiliate_id}/payouts/completed',
            pathalt: [{ "path": "/v2/affiliates/{affiliate_id}/payouts/completed", "affiliate_id": true }],
            params: [
                "affiliate_id"
            ],
            alias: {},
...
exports.PayoutCompletedEntity = PayoutCompletedEntity;
