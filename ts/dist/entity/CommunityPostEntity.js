...
exports.CommunityPostEntity = void 0;
...
class CommunityPostEntity {
    ...
    make() {
        return new CommunityPostEntity(this.#client, this.entopts());
    }
    data(data) {
        const featurehook = this.#utility.featurehook;
        if (null != data) {
    ...
    toJSON() {
        return { ...(this.#data || {}), _entity: 'CommunityPost' };
    }
    toString() {
        return 'CommunityPost ' + this.#utility.struct.jsonify(this.#data);
    }
    ...
    async load(reqmatch, ctrl) {
        ...
        const op = opify({
            ...
            pathalt: [{ "path": "/v2/community/posts/{id}", "id": true }],
            params: [
                "id"
            ],
            alias: {},
    ...
    async list(reqmatch, ctrl) {
        ...
        let op = opify({
            ...
            pathalt: [{ "path": "/v2/community/posts" }],
            params: [],
            alias: {},
            state: {},
            reqform: "`body`",
...
exports.CommunityPostEntity = CommunityPostEntity;
