...
exports.SchoolEventEntity = void 0;
...
class SchoolEventEntity {
    ...
    make() {
        return new SchoolEventEntity(this.#client, this.entopts());
    }
    data(data) {
        const featurehook = this.#utility.featurehook;
        if (null != data) {
    ...
    toJSON() {
        return { ...(this.#data || {}), _entity: 'SchoolEvent' };
    }
    toString() {
        return 'SchoolEvent ' + this.#utility.struct.jsonify(this.#data);
    }
...
exports.SchoolEventEntity = SchoolEventEntity;
