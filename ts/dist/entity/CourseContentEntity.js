...
exports.CourseContentEntity = void 0;
...
class CourseContentEntity {
    ...
    make() {
        return new CourseContentEntity(this.#client, this.entopts());
    }
    data(data) {
        const featurehook = this.#utility.featurehook;
        if (null != data) {
    ...
    toJSON() {
        return { ...(this.#data || {}), _entity: 'CourseContent' };
    }
    toString() {
        return 'CourseContent ' + this.#utility.struct.jsonify(this.#data);
    }
    ...
    async load(reqmatch, ctrl) {
        ...
        const op = opify({
            ...
            pathalt: [{ "path": "/v2/courses/{course_id}/contents", "course_id": true }],
            params: [
                "course_id"
            ],
            alias: {},
            ...
            reqform: "`body`",
            resform: "`body`",
            validate: { "params": { "course_id": "`$STRING`", "Authorization": "`$STRING`", "Lw-Client": "`$STRING`" } },
        });
        let ctx = contextify({
            current: new WeakMap(),
            ctrl,
    ...
    async create(reqdata, ctrl) {
        ...
        let op = opify({
            ...
            pathalt: [{ "path": "/v2/courses/{course_id}/sections", "course_id": true }],
            params: [
                "course_id"
            ],
            alias: {},
...
exports.CourseContentEntity = CourseContentEntity;
