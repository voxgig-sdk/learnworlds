...
exports.CommunityCollectionEntity = void 0;
const node_util_1 = require("node:util");
class CommunityCollectionEntity {
    #client;
    #entopts;
    #utility;
    #data;
    ...
    make() {
        return new CommunityCollectionEntity(this.#client, this.entopts());
    }
    data(data) {
        const featurehook = this.#utility.featurehook;
        if (null != data) {
    ...
    toJSON() {
        return { ...(this.#data || {}), _entity: 'CommunityCollection' };
    }
    toString() {
        return 'CommunityCollection ' + this.#utility.struct.jsonify(this.#data);
    }
    ...
    async list(reqmatch, ctrl) {
        ...
        let op = opify({
            ...
            pathalt: [{ "path": "/v2/community/collections" }],
            params: [],
            alias: {},
            state: {},
            reqform: "`body`",
...
exports.CommunityCollectionEntity = CommunityCollectionEntity;
