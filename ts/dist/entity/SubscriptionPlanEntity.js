...
class SubscriptionPlanEntity {
    ...
    make() {
        return new SubscriptionPlanEntity(this.#client, this.entopts());
    }
    data(data) {
        const featurehook = this.#utility.featurehook;
        if (null != data) {
    ...
    toJSON() {
        return { ...(this.#data || {}), _entity: 'SubscriptionPlan' };
    }
    toString() {
        return 'SubscriptionPlan ' + this.#utility.struct.jsonify(this.#data);
    }
    ...
    async load(reqmatch, ctrl) {
        ...
        const op = opify({
            ...
            pathalt: [{ "path": "/v2/subscription-plans/{id}", "id": true }],
            params: [
                "id"
            ],
            alias: {},
    ...
    async list(reqmatch, ctrl) {
        ...
        let op = opify({
            ...
            pathalt: [{ "path": "/v2/subscription-plans" }],
            params: [],
            alias: {},
            state: {},
            reqform: "`body`",
