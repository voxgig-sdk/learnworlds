...
exports.UserSegmentEntity = void 0;
const node_util_1 = require("node:util");
class UserSegmentEntity {
    #client;
    #entopts;
    #utility;
    #data;
    ...
    make() {
        return new UserSegmentEntity(this.#client, this.entopts());
    }
    data(data) {
        const featurehook = this.#utility.featurehook;
        if (null != data) {
    ...
    toJSON() {
        return { ...(this.#data || {}), _entity: 'UserSegment' };
    }
    toString() {
        return 'UserSegment ' + this.#utility.struct.jsonify(this.#data);
    }
    ...
    async list(reqmatch, ctrl) {
        ...
        let op = opify({
            ...
            pathalt: [{ "path": "/v2/users/segments" }],
            params: [],
            alias: {},
            state: {},
            reqform: "`body`",
...
exports.UserSegmentEntity = UserSegmentEntity;
